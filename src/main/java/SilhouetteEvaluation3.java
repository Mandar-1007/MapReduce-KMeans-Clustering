...
public class SilhouetteEvaluation3 {
    ...
    public static void runIteration(Configuration conf, String inputPath, String seedFilePath, String outputPath, int iteration) throws Exception {
        ...
        job.setJarByClass(SilhouetteEvaluation3.class);
    ...
    public static double calculateCentroidDisplacement(String prevSeedFile, String currSeedFile) throws IOException {
        List<double[]> prevCentroids = CentroidMapper.loadCentroids(prevSeedFile);
        List<double[]> currCentroids = CentroidMapper.loadCentroids(currSeedFile);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputPath = ".../Project2/output/Silhouette3";
        int iterations = 30;  // Change iterations as needed
        double threshold = 5;
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            String currSeedFile = outputPath + "/iteration_" + i + "/part-r-00000";
