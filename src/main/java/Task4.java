...
public class Task4 {
    ...
    // Combiner class (same as the Reducer in this case)
    ...
    public static void runIteration(Configuration conf, String inputPath, String seedFilePath, String outputPath, int iteration) throws Exception {
        ...
        job.setCombinerClass(CentroidCombiner.class);  // Set the combiner class
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputBasePath = ".../Project2/output/task4";
